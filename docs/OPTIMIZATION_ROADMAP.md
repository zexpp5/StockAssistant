...
**当前等待激活**：Anthropic API（充值后跑 Phase 2C/4 LLM 研报）+ FMP Premium（解锁 Phase 3 电话会议）→ 详见 [docs/archive/2026-05-10_付费数据源升级清单.md](2026-05-10_付费数据源升级清单.md)
...
| **Ledoit-Wolf shrinkage 协方差（默认）**| ✅ **已做 (2026-05-10 P1)** | [落地报告](2026-05-10_组合优化层P1落地_LedoitWolf_相关性_风险闸门.md) |
| **Pairwise correlation < 0.7 选股剪枝（三档退化）**| ✅ **已做 (2026-05-10 P1)** | 同上 |
| **风险闸门反馈到优化（4 级降级，非事后报告）**| ✅ **已做 (2026-05-10 P1)** | 同上 |
