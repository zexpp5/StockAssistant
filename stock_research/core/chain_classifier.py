...
_RULES: list[tuple[int, str, list[str], ChainTag]] = [
    ...
    (100, "name", ["Western Digital", "Seagate", "SanDisk", "Silicon Motion"],
        ChainTag("AI 算力", "上游", "NAND/HDD/SSD 控制器", "AI 训练和推理数据增长带动存储与控制器需求")),
    (100, "name", ["光模块", "中际旭创", "新易盛", "天孚", "源杰",
                   "Coherent", "Lumentum", "Fabrinet", "Ciena", "Applied Optoelectronics"],
        ChainTag("AI 算力", "中游", "光模块/CPO", "AI 服务器之间的高速光通信组件")),
    (98, "name", ["ASE Technology", "Amkor", "Axcelis", "Cohu"],
        ChainTag("AI 算力", "中游", "先进封装/测试设备", "AI 芯片封装、测试和制程设备产能")),
    ...
    (87, "name", ["Intuit", "Veeva", "Autodesk", "ServiceNow", "Workday",
                  "Adobe", "Salesforce"],
        ChainTag("互联网/云", "下游", "美股 SaaS 龙头", "财税/医药/设计 SaaS · AI 助手化")),
    # A 股锂电正极材料（动力电池上游 → 归新能源车中游）
    (87, "name", ["中伟新材", "当升科技", "容百科技", "贝特瑞", "璞泰来",
                  "厦钨新能", "杉杉股份"],
        ChainTag("新能源车", "中游", "锂电正极/负极材料", "动力 + 储能电池上游材料")),
    # A 股扫地机器人 / 服务机器人（石头科技 + 同业）
    (87, "name", ["石头科技", "科沃斯", "九号公司"],
        ChainTag("机器人/自动化", "下游", "消费机器人/扫地机", "扫地机/平衡车/AI 智能硬件")),
    # A 股医美 / 医疗器械（爱美客 + 惠泰医疗 等长期 picks 高分）
    (87, "name", ["爱美客", "华熙生物", "昊海生科", "惠泰医疗",
                  "迈瑞医疗", "联影医疗", "微创医疗"],
        ChainTag("创新药", "下游", "医美/医疗器械", "医美玻尿酸 / 影像 / 介入器械")),
