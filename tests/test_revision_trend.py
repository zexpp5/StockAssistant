...
class TestRevisionTrend(unittest.TestCase):
    def test_revision_trend_upgrading(self):
    ...
    def test_revision_trend_downgrading(self):
        s = summarize_revision_trend(
            [
    ...
    def test_revision_trend_diverging(self):
        s = summarize_revision_trend(
            [
                {"event_date": "2026-07-01", "price_target_action": "raises", "price_target": 120, "prior_price_target": 100},
    ...
    def test_revision_trend_quiet_for_maintains(self):
        s = summarize_revision_trend(
            [
    ...
    def test_revision_trend_empty_data(self):
